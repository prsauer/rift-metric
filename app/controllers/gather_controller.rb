class GatherController < ApplicationController
  ...
  def index
    ...
    hg.query_history(id)["matches"].slice(0,5).each do |match|

      match_info = hg.query_match(match["matchId"])
      #match_info = hg.query_match(2004047199)
      ...
      match_row.team1_ban1 = match_info["teams"][team_1_index]["bans"][0]["championId"]
      match_row.team1_ban2 = match_info["teams"][team_1_index]["bans"][1]["championId"]
      match_row.team1_ban3 = match_info["teams"][team_1_index]["bans"][2]["championId"]

      match_row.team2_ban1 = match_info["teams"][team_2_index]["bans"][0]["championId"]
      match_row.team2_ban2 = match_info["teams"][team_2_index]["bans"][1]["championId"]
      match_row.team2_ban3 = match_info["teams"][team_2_index]["bans"][2]["championId"]

      #puts match_row.inspect

      puts match_row.errors.messages unless match_row.save

      #puts parts.to_s
      puts "Events : "
      puts match_info["timeline"]["frames"][1].keys
      participant_id_map = Hash.new
