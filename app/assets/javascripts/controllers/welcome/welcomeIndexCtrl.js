...
angular.module('mainApp').controller('IndexCtrl', ['$scope', '$location', '$http', 'KillData', 'DeathData', 'MatchList', function($scope, $location, $http, KillData, DeathData, MatchList) {
  console.log("IndexCtrl firing");
  ...
  //   return $http.get('./data/all_kills.json?name=xbanthur').success(function(data) {
